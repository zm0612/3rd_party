...
class MathUtil {
 public:
  ...
  //     S2::int64 b = Round<S2::int64>(0.3 * z);
  //
  ...
  //   functions (for "int" and "S2::int64" only), but it's safer to call them
  //   directly.
  //
  ...
  static S2::int32 FastIntRound(double x) {
...
#else
    return Round<S2::int32, double>(x);
#endif  // if defined __GNUC__ && ...
  }

  static S2::int64 FastInt64Round(double x) {
...
#else
    return Round<S2::int64, double>(x);
#endif  // if defined __GNUC__ && ...
  }
};
...
template<>
inline S2::int32 MathUtil::Round<S2::int32, double>(double x) {
  return FastIntRound(x);
}

template<>
inline S2::int32 MathUtil::Round<S2::int32, float>(float x) {
  return FastIntRound(x);
}

template<>
inline S2::int64 MathUtil::Round<S2::int64, double>(double x) {
  return FastInt64Round(x);
}

template<>
inline S2::int64 MathUtil::Round<S2::int64, float>(float x) {
  return FastInt64Round(x);
}
